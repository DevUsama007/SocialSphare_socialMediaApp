...
class AddShortVideo extends StatefulWidget {
  const AddShortVideo({super.key});

  @override
  State<AddShortVideo> createState() => _AddShortVideoState();
}

class _AddShortVideoState extends State<AddShortVideo> {
// get the user data
  User? _user;
  String? _uid;
...
// get the user data ends here
  ...
  final firestore = FirebaseFirestore.instance.collection('short_videos');
  Future UploadShortVideo() async {
    setState(() {
      uploading = true;
    });
    print("click");
      ...
      appBar: AppBar(
        ...
        actions: [
          uploading
              ? Container()
              : TextButton(
                  onPressed: pickedvideo == null || uploading
                      ? null
                      : () {
                          // pick_image();
                          UploadShortVideo();
