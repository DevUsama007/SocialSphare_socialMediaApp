...
class userImagePost extends StatefulWidget {
  ...
  @override
  _userImagePostState createState() => _userImagePostState();
}

class _userImagePostState extends State<userImagePost> {
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            child: Image.network(fit: BoxFit.cover, widget.postUrl),
          ),
          SizedBox(
            height: 5,
          ),
